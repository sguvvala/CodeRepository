...
* Build Process:
* --------------
*   devenv StringSocketServer.sln /debug rebuild
*
* Maintenance History:
* --------------------
* ver 1.0 : 05/01/2016
* Added getAttib function to the Abstract XML element that returns the
* string reference to the attributes with the given name

* Maintenance History: (Dr. Jim Fawcett)
* --------------------
* ver 1.7 : 16 Mar 2015
...
namespace XmlProcessing
{
	...
	public:
		...
		virtual std::string& getAttrib(const std::string& name);
	...
	inline std::string& AbstractXmlElement::getAttrib(const std::string& name) { return emptyString; }
