...
//----< build different kind of messages >--------------------------------------
HttpMessage HttpMessage::makeMessage(size_t n, const std::string& body, const std::string& remoteUrl, const std::string& localUrl) {
  HttpMessage msg;
  ...
  case 1:
	...
	msg.addAttribute(HttpMessage::parseAttribute("toAddr:" + remoteUrl));
  ...
  case 9:
	msg.clear();
	msg.addAttribute(HttpMessage::attribute("Command", "Shutdown Server"));
	msg.addAttribute(HttpMessage::Attribute("mode", "oneway"));
	msg.addAttribute(HttpMessage::parseAttribute("toAddr:" + remoteUrl));
	msg.addAttribute(HttpMessage::parseAttribute("fromAddr:" + localUrl));
	break;
  ...
  case 10:
	msg.clear();
	msg.addAttribute(HttpMessage::attribute("Command", "Shutdown Client"));
	msg.addAttribute(HttpMessage::Attribute("mode", "oneway"));
	msg.addAttribute(HttpMessage::parseAttribute("toAddr:" + remoteUrl));
	msg.addAttribute(HttpMessage::parseAttribute("fromAddr:" + localUrl));
	break;
